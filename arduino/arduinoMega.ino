...
void deviceManager(char message[]) {
  ...
  && message[4] == 'H') {
    ...
    char PH_sol_nut_analogReading_1 = (48 + (PH_sol_nut_analogReading/100));
    char PH_sol_nut_analogReading_2 = (48 + ((PH_sol_nut_analogReading - ((PH_sol_nut_analogReading/100)*100))/10));
    char PH_sol_nut_analogReading_3 = (48 + (PH_sol_nut_analogReading - ((PH_sol_nut_analogReading/100)*100) - (((PH_sol_nut_analogReading - ((PH_sol_nut_analogReading/100)*100))/10)*10)));
